...
<ol type="1">
  <li>Merchant melakukan Request Registrasi CVS ke NICEPay.
  <li>Merchant menampilkan detail dan cara pembayaran.
  <li>Pembeli melakukan pembayaran dengan mengunjungi Toko Mitra terdekat.
  <li>NICEPay mengirimkan Notifikasi real-time ke Merchant.
</ol>
...
| **`payMethod`** **Required**      | **N**             | **2**    | [Pay Method](#payment-method) | 03                                                           |
