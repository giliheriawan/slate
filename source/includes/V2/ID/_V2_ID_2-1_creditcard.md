...
Integration Step :
<ol type="1">
  <li>Merchant meminta Registrasi Kartu Kredit to NICEPay.
  <li>Merchant meminta Pembayaran Kartu Kredit to NICEPay.
  <li>NICEPay redirect ke Halaman 3DS / MIGS Bank.
  <li>Pelanggan input OTP di Halaman Bank.
...
Pembayaran Kartu Kredit akan bisa di proses jika [CC Registration](#cc-registration) adalah **Sukses**
...
<br>Silahkan lihat ke [sini](#payment) untuk request JSON Desc and and response parameters<br>
...
<br>**Response POST Paramenter (redirect ke callbackUrl)**
