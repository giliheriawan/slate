...
NICEPay menawarkan **Payloan**  sebagai metode pembayaran. Pemberitahuan Real Time akan dikirim saat pelanggan menyelesaikan pembayaran.<br>
Supported yang didukung oleh NICEPay:
<ol type="1">
  <li>Akulaku</li>
  <li>Kredivo</li>
</ol>
...
Integration Step :
<ol type="1">
  <li>Merchant meminta Registrasi Payloan ke NICEPay.
  <li>Merchant meminta Payment Payloan ke NICEPay.
  <li>NICEPay akan redirect ke halaman Mitra.
  <li>Pelanggan membayarkan Payloan.
...
dibawah ini unutk parameter ekstra yang dibutuhkan untuk registrasi AKULAKU:
...
Pembayaran Akulaku akan bisa di proses jika [Akulaku Registration](#akulaku-registration) adalah **Success**
...
<br>POST request dan response parameters<br>
**Request Parameter**
...
<br>Silahkan lihat ke [sini](#registration) untuk JSON parameters.<br>
dibawah ini unutk parameter ekstra yang dibutuhkan untuk registrasi KREDIVO:
...
Pembayaran Kredivo akan bisa di proses jika [Kredivo Registration](#kredivo-registration) adalah **Success**
